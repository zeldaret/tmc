...
void SortEntityAbove(Entity* relativeTo, Entity* above) {
    above->spritePriority.b0 = gUnk_08114F78[relativeTo->spritePriority.b0];
}

void SortEntityBelow(Entity* relativeTo, Entity* below) {
    below->spritePriority.b0 = gUnk_08114F80[relativeTo->spritePriority.b0];
}
