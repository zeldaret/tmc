...
sub_08039D4C: @ 0x08039D4C
	push {lr}
	adds r2, r0, #0
	ldr r0, _08039D64 @ =gUnk_03003F80
	ldrb r1, [r0, #0x1c]
	movs r0, #0xf
	ands r0, r1
	cmp r0, #0
...
_08039E38:
	ldr r0, _08039E6C @ =gUnk_03003F80
	ldr r0, [r0, #0x30]
	movs r1, #0x80
	ands r0, r1
	cmp r0, #0
...
sub_0803B798: @ 0x0803B798
	ldr r2, _0803B7F4 @ =gUnk_03003F80
	movs r1, #0
	movs r0, #0x41
	strb r0, [r2, #2]
	strb r1, [r2, #0xa]
...
sub_0803B824: @ 0x0803B824
	...
	adds r5, r0, #0
	bl sub_08077B2C
	ldr r2, _0803B864 @ =gUnk_03003F80
	ldrb r1, [r2, #0x1a]
	movs r0, #0x80
	orrs r0, r1
	strb r0, [r2, #0x1a]
...
sub_0803B870: @ 0x0803B870
	...
	cmp r0, #0
	beq _0803B8DC
	ldr r0, _0803B8D4 @ =gUnk_03003F80
	ldr r0, [r0, #0x30]
	movs r1, #0x10
	ands r0, r1
	cmp r0, #0
...
_0803E158:
	ldr r2, _0803E178 @ =gUnk_03003F80
	ldr r0, [r2, #0x30]
...
sub_0803E444: @ 0x0803E444
	...
	adds r4, r0, #0
	bl sub_08077B2C
	ldr r2, _0803E478 @ =gUnk_03003F80
	ldrb r1, [r2, #0x1a]
	movs r0, #0x80
	orrs r1, r0
	strb r1, [r2, #0x1a]
...
sub_0803F6EC: @ 0x0803F6EC
	...
	adds r0, #0x45
	ldrb r0, [r0]
	ldr r3, _0803F730 @ =gUnk_03003F80
	cmp r0, #0
	beq _0803F720
	ldrb r1, [r2, #0x10]
	movs r0, #0x80
...
sub_0803F738: @ 0x0803F738
	...
	adds r4, r0, #0
	bl sub_08077B2C
	ldr r2, _0803F768 @ =gUnk_03003F80
	ldrb r1, [r2, #0x1a]
	movs r0, #0x80
	orrs r1, r0
	strb r1, [r2, #0x1a]
...
_08040AB0:
	...
	cmp r0, #0x8a
	bne _08040AC8
	ldr r0, _08040AD0 @ =gUnk_03003F80
	adds r0, #0xa0
	ldrb r0, [r0]
	cmp r0, #5
	bne _08040AC8
...
_08041200:
	...
	b _08041224
_08041204:
	ldr r0, _08041214 @ =gUnk_03003F80
	ldr r0, [r0, #0x30]
	movs r1, #0x80
	lsls r1, r1, #0x10
	ands r0, r1
...
_08041592:
	...
	str r0, [r1, #0x30]
	ldr r0, _080415C8 @ =gUnk_03003F80
	adds r0, #0x8b
	movs r1, #1
	strb r1, [r0]
	b _080415E6
...
_080423D4:
	ldr r2, _08042420 @ =gUnk_03003F80
	adds r0, r2, #0
	adds r0, #0xa9
	ldrb r0, [r0]
	cmp r0, #1
...
sub_08043DB0: @ 0x08043DB0
	push {r4, r5, r6, lr}
	adds r5, r0, #0
	ldr r0, _08043E48 @ =gUnk_03003F80
	ldr r0, [r0, #0x30]
	movs r1, #0x80
	ands r0, r1
	cmp r0, #0
...
sub_08044498: @ 0x08044498
	...
	lsls r0, r0, #6
	orrs r4, r0
	ldr r0, _08044540 @ =gUnk_03003F80
	adds r0, #0x92
	ldrh r0, [r0]
	movs r1, #0xf0
	lsls r1, r1, #4
...
sub_08044550: @ 0x08044550
	push {r4, r5, r6, r7, lr}
	adds r6, r0, #0
	ldr r0, _080445A8 @ =gUnk_03003F80
	ldrb r1, [r0, #0x1c]
	movs r0, #0xf
	ands r0, r1
	cmp r0, #1
...
sub_08045BC8: @ 0x08045BC8
	...
	strh r0, [r1, #0x36]
_08045C16:
	ldr r0, _08045C30 @ =gUnk_03003F80
	adds r0, #0x27
	movs r1, #0xff
	strb r1, [r0]
...
sub_08045E14: @ 0x08045E14
	push {r4, lr}
	adds r4, r0, #0
	ldr r0, _08045E2C @ =gUnk_03003F80
	adds r0, #0x27
	movs r1, #0xff
	strb r1, [r0]
	ldrb r0, [r4, #0xd]
...
sub_08046078: @ 0x08046078
	push {r4, r5, r6, r7, lr}
	adds r7, r0, #0
	ldr r0, _08046114 @ =gUnk_03003F80
	adds r0, #0x27
	movs r1, #0
	strb r1, [r0]
...
sub_080465C8: @ 0x080465C8
	...
	cmp r0, #0
	beq _080465F8
	ldr r1, _08046608 @ =gUnk_03003F80
	movs r0, #1
	strb r0, [r1, #0x14]
_080465F8:
	pop {r4, pc}
...
sub_08047D88: @ 0x08047D88
	...
	cmp r0, #3
	bne _08047DB0
	ldr r0, _08047DE8 @ =gUnk_03003F80
	ldrb r0, [r0, #0x14]
	cmp r0, #0
	bne _08047DE6
_08047DB0:
...
sub_08049944: @ 0x08049944
	...
	cmp r0, #0
	beq _0804998C
	ldr r2, _08049994 @ =gUnk_03003F80
	movs r0, #1
	strb r0, [r2, #0x14]
	movs r1, #0x36
	ldrsh r0, [r5, r1]
...
sub_08049E18: @ 0x08049E18
	push {lr}
	ldr r1, _08049E38 @ =gUnk_03003F80
	adds r0, r1, #0
	adds r0, #0x3c
	ldrb r0, [r0]
	cmp r0, #0
...
sub_08049E4C: @ 0x08049E4C
	push {lr}
	ldr r1, _08049E6C @ =gUnk_03003F80
	adds r0, r1, #0
	adds r0, #0x3c
	ldrb r0, [r0]
	cmp r0, #0
...
sub_08049E80: @ 0x08049E80
	push {lr}
	ldr r1, _08049E9C @ =gUnk_03003F80
	adds r0, r1, #0
	adds r0, #0x3c
	ldrb r0, [r0]
	cmp r0, #0
...
sub_08049EB0: @ 0x08049EB0
	push {lr}
	ldr r1, _08049ED0 @ =gUnk_03003F80
	adds r0, r1, #0
	adds r0, #0x3c
	ldrb r0, [r0]
	cmp r0, #0
